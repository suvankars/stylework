...
class TaxRatesControllerTest < ActionController::TestCase
  ...
  test "should create tax_rate" do
    assert_difference('TaxRate.count') do
      post :create, tax_rate: { code: @tax_rate.code, description: @tax_rate.description, name: @tax_rate.name, rate: @tax_rate.rate }
    end
  ...
  test "should update tax_rate" do
    patch :update, id: @tax_rate, tax_rate: { code: @tax_rate.code, description: @tax_rate.description, name: @tax_rate.name, rate: @tax_rate.rate }
    assert_redirected_to tax_rate_path(assigns(:tax_rate))
  end
